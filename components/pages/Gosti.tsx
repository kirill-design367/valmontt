...
const RULES = [
  { name: 'СПИСОК', note: 'Закрывается за месяц. Мы его не публикуем.' },
  { name: 'ПРИГЛАШЕНИЕ', note: 'Приходит один раз, на бумаге, на одного.' },
  { name: 'ТЕЛЕФОНЫ', note: 'Сдаются на въезде. Возвращаются на выезде.' },
  { name: 'СЪЁМКА', note: 'Запрещена везде, включая террасу.' },
]
